...
BuildCostIQ version `v0.7.0-rc1` is a local-first construction-cost foundation and full P01–P08 project workbench. The architecture is frozen around a small Core, independent adapters, and exactly eight plugin capabilities (`P01`–`P08`).
...
The homepage shows the current release version and release highlights. The workbench now exposes one direct screen for each capability: P01 contract intake, P02 BOQ intake, P03 drawing register, P04 zero ledger, P05 cost planning, P06 change management, P07 evidence linkage, and P08 settlement review. It also provides role-aware dashboards, local baseline comparison, automated alerts, file viewing, permission-gated edits and soft deletes, multi-file project intake, local recognition, and explicit external OCR consent.
